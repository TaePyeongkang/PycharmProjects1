...
class Main(QWidget, form_class):
    ...
    def recommendBook1(self):
        Booksearchpage.bookname.setText("혼자 가는 먼 집")
        Booksearchpage.searchlist()
        widget.setCurrentIndex(3)
        Booksearchpage.stackedWidget.setCurrentIndex(1)
    def recommendBook2(self):
        Booksearchpage.bookname.setText("디디의 우산")
        Booksearchpage.searchlist()
        widget.setCurrentIndex(3)
        Booksearchpage.stackedWidget.setCurrentIndex(1)
    def recommendBook3(self):
        Booksearchpage.bookname.setText("이만큼 가까이")
        Booksearchpage.searchlist()
        widget.setCurrentIndex(3)
        Booksearchpage.stackedWidget.setCurrentIndex(1)
    def recommendBook4(self):
        Booksearchpage.bookname.setText("일기시대")
        Booksearchpage.searchlist()
        widget.setCurrentIndex(3)
        Booksearchpage.stackedWidget.setCurrentIndex(1)
    def recommendBook5(self):
        Booksearchpage.bookname.setText("내가 되는 꿈")
        Booksearchpage.searchlist()
        widget.setCurrentIndex(3)
        Booksearchpage.stackedWidget.setCurrentIndex(1)
    ...
    def openURL(self):
        webbrowser.open_new("https://lib.gwangsan.go.kr/JD/board/3")  # 공지사항으로 이동
