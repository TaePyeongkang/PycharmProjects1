...
class Rental_page(QWidget, form_widget):
    def __init__(self):
        ...
        self.YH_rent.clicked.connect(self.Information_event)
        ...
        # self.YH_main.horizontalHeader().setStretchLastSection(True)
        self.YH_main.setColumnWidth(0, 25)
    ...
    def CellValue(self,row,column):
        ...
        self.YH_label2.setText(label_string)
