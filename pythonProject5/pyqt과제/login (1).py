...
class Login(QWidget, form_class):
    ...
    def Double_Check(self):         # 회원가입 페이지-중복 확인하는 함수
        ...
        with open('Member.txt', 'r') as f:      # 읽기모드로 파일열기
            ...
            if dc == 1:
                ...
                self.checkStatus = False            #중복확인 완료하면 다시
    ...
    def Sign_Up(self):
        ...
        with open('Userinfo.txt', 'a') as f:
            ...
            if pw1 != pw2:
                ...
                f.writelines(f"{id},{pw1},{name},{phone},{address}" + '\n')     # 사용자 정보 저장
                self.login_SW.setCurrentIndex(1)
    ...
    def Login_Check (self):
        id = self.login_id_lineEdit.text()
        ...
        if logined == 1:
            ...
            self.parent().setCurrentIndex(0)    # 로그인 성공
